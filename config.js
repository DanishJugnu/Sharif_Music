module.exports = {
	...
	supportServer: "https://discord.gg/py4WvAjghY", //- Support Server Link
	Issues: "https://discord.gg/py4WvAjghY", //- Bug Report Link
	...
	embedColor: "#a537fd", //- Color of the embeds, hex supported
	presence: {
		...
		activities: [
			{
				name: "Music in Sharif Sabha", //- Status Text
